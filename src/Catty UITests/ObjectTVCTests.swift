...
class ObjectTVCTests: XCTestCase, UITestProtocol {
    ...
    func testScriptsCanDeleteBrickSetSizeTo() {
        ...
        app.collectionViews.cells.element(boundBy: 1).staticTextBeginsOrEndsWith(kLocalizedSetSizeTo).tap()
    ...
    func testScriptsCanDeleteWaitBrick() {
        ...
        app.collectionViews.cells.element(boundBy: 4).staticTextBeginsOrEndsWith(kLocalizedWait).tap()
        app.buttons[kLocalizedDeleteBrick].tap()
        app.swipeDown()
