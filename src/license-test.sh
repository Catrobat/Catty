...
done < <(find . -type d \( -o -name "Reachability" -name "TTTAttributedLabel" -o -name "minizip" -o -name "SSZipArchive" -o -name "GDataXMLNode" \) -prune -o -type f \( -name "*.m" -o -name "*.h" -o -name "*.pch" \) -print)
