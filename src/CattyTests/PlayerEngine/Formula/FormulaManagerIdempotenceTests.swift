...
final class FormulaManagerIdempotenceTest: XCTestCase {
    ...
    func testMultiplication() {
        let subElement = FormulaElement(elementType: ElementType.OPERATOR, value: Operators.getName(Operator.MINUS), leftChild: FormulaElement(integer: 3), rightChild: FormulaElement(integer: 5), parent: nil)
