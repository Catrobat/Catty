...
final class WaitBrickCellTests: XCTestCase {

    var brick: WaitBrick!
    var brickCell: WaitBrickCell!
    ...
    func testTitleSingular() {
        let expectedTitle = kLocalizedWait + " %@ " + kLocalizedSecond

        brick.timeToWaitInSeconds = Formula(double: 1)
    ...
    func testTitlePlural() {
        let expectedTitle = kLocalizedWait + " %@ " + kLocalizedSeconds
