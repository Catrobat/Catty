...
final class SettingsTableViewControllerTests: XCTestCase {

    var controller: SettingsTableViewController?
    ...
    func testFirebaseCrashReportEnabledNotification() {
    ...
    func testFirebaseCrashReportDisabledNotification() {
