...
class ChartProgramsStoreDataSourceTests: XCTestCase {
    ...
    func testMostDownloadedProgramEmpty() {
        self.downloaderMock.program =
            StoreProgram(projectId: 0, projectName: "", projectNameShort: "",
                         author: "", description: "", version: "", views: 0, downloads: 0,
                         isPrivate: false, uploaded: 0, uploadedString: "", screenshotBig: "",
