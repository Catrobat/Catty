...
- (void)testNestedForeverBricks {
    ...
    BOOL canMoveInsideForeverBrickInsertMode = [[BrickMoveManager sharedInstance] collectionView:self.viewController.collectionView
                                                                                        itemAtIndexPath:indexPathFrom
                                                                                     canMoveToIndexPath:indexPathTo
                                                                                              andObject:self.spriteObject];
...
- (void)testIfBrickInsideForeverBrick {
    [self.viewController.collectionView reloadData];
    ...
    BOOL canMoveAboveForeverBrickEditMode = [[BrickMoveManager sharedInstance] collectionView:self.viewController.collectionView
                                                                                    ...
                                                                                    canMoveToIndexPath:indexPathTo
                                                                                             andObject:self.spriteObject];
    XCTAssertFalse(canMoveAboveForeverBrickEditMode, @"Should not be allowed to move IfBrick inside forever-loop above ForeverBrick in edit mode");
    
    ifLogicBeginBrick.animateInsertBrick = YES;
    BOOL canMoveAboveForeverBrickInsertMode = [[BrickMoveManager sharedInstance] collectionView:self.viewController.collectionView
                                                                                         itemAtIndexPath:indexPathFrom
                                                                                      canMoveToIndexPath:indexPathTo
                                                                                               andObject:self.spriteObject];
    XCTAssertTrue(canMoveAboveForeverBrickInsertMode, @"Should be allowed to move IfBrick inside forever-loop above ForeverBrick in insert mode");
}
