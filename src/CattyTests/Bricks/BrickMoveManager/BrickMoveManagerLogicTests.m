...
- (void)testForeverBrickInsideIfBrick {
    ...
    BOOL canMoveInsideIfBrickInsertMode = [[BrickMoveManager sharedInstance] collectionView:self.viewController.collectionView
                                                                                         itemAtIndexPath:indexPathFrom
                                                                                      canMoveToIndexPath:indexPathTo
                                                                                               andObject:self.spriteObject];
    ...
    foreverBrick.animateInsertBrick = YES;
    canMoveInsideIfBrickInsertMode = [[BrickMoveManager sharedInstance] collectionView:self.viewController.collectionView
                                                                               itemAtIndexPath:indexPathFrom
                                                                            canMoveToIndexPath:indexPathTo
                                                                                     andObject:self.spriteObject];
...
- (void)testIfBrickAboveIfBrick {
    ...
    BOOL canMoveAboveIfBrickEditMode = [[BrickMoveManager sharedInstance] collectionView:self.viewController.collectionView
                                                                               ...
                                                                               canMoveToIndexPath:indexPathTo
                                                                                        andObject:self.spriteObject];
    XCTAssertFalse(canMoveAboveIfBrickEditMode, @"Should not be allowed to move nested IfLogicBeginBrick above main IfLogicBeginBrick in edit mode");
    
    ifLogicBeginBrick2.animateInsertBrick = YES;
    BOOL canMoveAboveIfBrickInsertMode = [[BrickMoveManager sharedInstance] collectionView:self.viewController.collectionView
                                                                                    itemAtIndexPath:indexPathFrom
                                                                                 canMoveToIndexPath:indexPathTo
                                                                                          andObject:self.spriteObject];
    XCTAssertTrue(canMoveAboveIfBrickInsertMode, @"Should be allowed to move nested IfLogicBeginBrick above main IfLogicBeginBrick in insert mode");
}

- (void)testIfLogicBeginBricksInsideElseBranch {
    [self.viewController.collectionView reloadData];
    ...
    BOOL canMoveAboveIfBrickEditMode = [[BrickMoveManager sharedInstance] collectionView:self.viewController.collectionView
                                                                              ...
                                                                              canMoveToIndexPath:indexPathTo
                                                                                       andObject:self.spriteObject];
    XCTAssertFalse(canMoveAboveIfBrickEditMode, @"Should not be allowed to move nested IfLogicBeginBrick above main IfLogicElseBrick in edit mode");
    ...
    BOOL canMoveAboveIfBrickInsertMode = [[BrickMoveManager sharedInstance] collectionView:self.viewController.collectionView
                                                                                ...
                                                                                canMoveToIndexPath:indexPathTo
                                                                                         andObject:self.spriteObject];
    XCTAssertTrue(canMoveAboveIfBrickInsertMode, @"Should be allowed to move nested IfLogicBeginBrick above main IfLogicElseBrick in insert mode");
    ...
    BOOL canMoveBelowIfBrickEditMode = [[BrickMoveManager sharedInstance] collectionView:self.viewController.collectionView
                                                                              ...
                                                                              canMoveToIndexPath:indexPathTo
                                                                                       andObject:self.spriteObject];
    XCTAssertFalse(canMoveBelowIfBrickEditMode, @"Should not be allowed to move main IfLogicElseBrick below nested IfLogicElseBrick in edit mode");
    
    ifLogicElseBrick1.animateInsertBrick = YES;
    BOOL canMoveBelowIfBrickInsertMode = [[BrickMoveManager sharedInstance] collectionView:self.viewController.collectionView
                                                                                   itemAtIndexPath:indexPathFrom
                                                                                canMoveToIndexPath:indexPathTo
                                                                                         andObject:self.spriteObject];
    XCTAssertTrue(canMoveBelowIfBrickInsertMode, @"Should be allowed to move main IfLogicElseBrick below nested IfLogicElseBrick in insert mode");
}
...
- (void)testMoveLogicBricks {
    ...
    BOOL canMoveAboveEndBrickEditMode = [[BrickMoveManager sharedInstance] collectionView:self.viewController.collectionView
                                                                               ...
                                                                               canMoveToIndexPath:indexPathTo
                                                                                        andObject:self.spriteObject];
    XCTAssertFalse(canMoveAboveEndBrickEditMode, @"Should not be allowed to move IfLogicBeginBrick above IfLogicEndBrick in edit mode");
    
    ifLogicBeginBrick2.animateInsertBrick = YES;
    BOOL canMoveAboveEndBrickInsertMode = [[BrickMoveManager sharedInstance] collectionView:self.viewController.collectionView
                                                                                    itemAtIndexPath:indexPathFrom
                                                                                 canMoveToIndexPath:indexPathTo
                                                                                          andObject:self.spriteObject];
    XCTAssertTrue(canMoveAboveEndBrickInsertMode, @"Should be allowed to move IfLogicBeginBrick above IfLogicEndBrick in insert mode");
    ...
    BOOL canMoveBelowIfBeginBrickEditMode = [[BrickMoveManager sharedInstance] collectionView:self.viewController.collectionView
                                                                                   ...
                                                                                   canMoveToIndexPath:indexPathTo
                                                                                            andObject:self.spriteObject];
    XCTAssertFalse(canMoveBelowIfBeginBrickEditMode, @"Should not be allowed to move IfLogicEndBrick below IfLogicBeginBrick in edit mode");
    
    ifLogicEndBrick1.animateInsertBrick = YES;
    BOOL canMoveBelowIfBeginBrickInsertMode = [[BrickMoveManager sharedInstance] collectionView:self.viewController.collectionView
                                                                                        itemAtIndexPath:indexPathFrom
                                                                                     canMoveToIndexPath:indexPathTo
                                                                                              andObject:self.spriteObject];
    XCTAssertTrue(canMoveBelowIfBeginBrickInsertMode, @"Should not allowed to move IfLogicEndBrick below IfLogicBeginBrick in insert mode");
}
