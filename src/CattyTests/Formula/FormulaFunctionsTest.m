...
- (void)testSin
{
    FormulaElement *formula = [self getFormulaElementForFunction:@"SIN" WithLeftValue:@"0" AndRightValue:nil]; // TODO use Function property
    XCTAssertEqualWithAccuracy(0, [[formula interpretRecursiveForSprite:nil] doubleValue], DELTA, @"Wrong result for sin(0)");
    
    formula = [self getFormulaElementForFunction:@"SIN" WithLeftValue:@"90" AndRightValue:nil]; // TODO use Function property
    XCTAssertEqualWithAccuracy(1, [[formula interpretRecursiveForSprite:nil] doubleValue], DELTA, @"Wrong result for sin(90)");
    
    formula = [self getFormulaElementForFunction:@"SIN" WithLeftValue:@"-90" AndRightValue:nil]; // TODO use Function property
    XCTAssertEqualWithAccuracy(-1, [[formula interpretRecursiveForSprite:nil] doubleValue], DELTA, @"Wrong result for sin(-90)");
    
    formula = [self getFormulaElementForFunction:@"SIN" WithLeftValue:@"180" AndRightValue:nil]; // TODO use Function property
    XCTAssertEqualWithAccuracy(0, [[formula interpretRecursiveForSprite:nil] doubleValue], DELTA, @"Wrong result for sin(180)");
    
    formula = [self getFormulaElementForFunction:@"SIN" WithLeftValue:@"-180" AndRightValue:nil]; // TODO use Function property
    XCTAssertEqualWithAccuracy(0, [[formula interpretRecursiveForSprite:nil]doubleValue], DELTA, @"Wrong result for sin(-180)");
    
    formula = [self getFormulaElementForFunction:@"SIN" WithLeftValue:@"360" AndRightValue:nil]; // TODO use Function property
    XCTAssertEqualWithAccuracy(0, [[formula interpretRecursiveForSprite:nil]doubleValue], DELTA, @"Wrong result for sin(360)");
    
    formula = [self getFormulaElementForFunction:@"SIN" WithLeftValue:@"750" AndRightValue:nil]; // TODO use Function property
...
- (void)testCos
{
    FormulaElement *formula = [self getFormulaElementForFunction:@"COS" WithLeftValue:@"0" AndRightValue:nil]; // TODO use Function property
    XCTAssertEqualWithAccuracy(1, [[formula interpretRecursiveForSprite:nil]doubleValue], DELTA, @"Wrong result for cos(0)");

    formula = [self getFormulaElementForFunction:@"COS" WithLeftValue:@"90" AndRightValue:nil]; // TODO use Function property
    XCTAssertEqualWithAccuracy(0, [[formula interpretRecursiveForSprite:nil]doubleValue], DELTA, @"Wrong result for cos(90)");
    
    formula = [self getFormulaElementForFunction:@"COS" WithLeftValue:@"-90" AndRightValue:nil]; // TODO use Function property
    XCTAssertEqualWithAccuracy(0, [[formula interpretRecursiveForSprite:nil]doubleValue], DELTA, @"Wrong result for cos(-90)");
    
    formula = [self getFormulaElementForFunction:@"COS" WithLeftValue:@"180" AndRightValue:nil]; // TODO use Function property
    XCTAssertEqualWithAccuracy(-1, [[formula interpretRecursiveForSprite:nil]doubleValue], DELTA, @"Wrong result for cos(180)");
    
    formula = [self getFormulaElementForFunction:@"COS" WithLeftValue:@"-180" AndRightValue:nil]; // TODO use Function property
    XCTAssertEqualWithAccuracy(-1, [[formula interpretRecursiveForSprite:nil]doubleValue], DELTA, @"Wrong result for cos(-180)");
    
    formula = [self getFormulaElementForFunction:@"COS" WithLeftValue:@"360" AndRightValue:nil]; // TODO use Function property
    XCTAssertEqualWithAccuracy(1, [[formula interpretRecursiveForSprite:nil]doubleValue], DELTA, @"Wrong result for cos(360)");

    formula = [self getFormulaElementForFunction:@"COS" WithLeftValue:@"-360" AndRightValue:nil]; // TODO use Function property
    XCTAssertEqualWithAccuracy(1, [[formula interpretRecursiveForSprite:nil]doubleValue], DELTA, @"Wrong result for cos(-360)");

    formula = [self getFormulaElementForFunction:@"COS" WithLeftValue:@"750" AndRightValue:nil]; // TODO use Function property
...
- (void)testTan
{
    FormulaElement *formula = [self getFormulaElementForFunction:@"TAN" WithLeftValue:@"0" AndRightValue:nil]; // TODO use Function property
    ...
    formula = [self getFormulaElementForFunction:@"TAN" WithLeftValue:@"90" AndRightValue:nil]; // TODO use Function property
    ...
    formula = [self getFormulaElementForFunction:@"TAN" WithLeftValue:@"180" AndRightValue:nil]; // TODO use Function property
    XCTAssertEqualWithAccuracy(0, [[formula interpretRecursiveForSprite:nil]doubleValue], DELTA, @"Wrong result for tan(180)");
    
    formula = [self getFormulaElementForFunction:@"TAN" WithLeftValue:@"-180" AndRightValue:nil]; // TODO use Function property
    XCTAssertEqualWithAccuracy(0, [[formula interpretRecursiveForSprite:nil]doubleValue], DELTA, @"Wrong result for tan(-180)");
    
    formula = [self getFormulaElementForFunction:@"TAN" WithLeftValue:@"360" AndRightValue:nil]; // TODO use Function property
    XCTAssertEqualWithAccuracy(0, [[formula interpretRecursiveForSprite:nil]doubleValue], DELTA, @"Wrong result for tan(360)");
    
    formula = [self getFormulaElementForFunction:@"TAN" WithLeftValue:@"-360" AndRightValue:nil]; // TODO use Function property
    XCTAssertEqualWithAccuracy(0, [[formula interpretRecursiveForSprite:nil]doubleValue], DELTA, @"Wrong result for tan(-360)");
    
    formula = [self getFormulaElementForFunction:@"TAN" WithLeftValue:@"750" AndRightValue:nil]; // TODO use Function property
