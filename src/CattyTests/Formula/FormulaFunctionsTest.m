...
- (void)testSin
{
    ...
    XCTAssertEqualWithAccuracy(0, [self.formulaManager interpretDouble:formula forSpriteObject:self.spriteObject], DELTA, @"Wrong result for sin(0)");
    
    formula = [self getFormulaForFunction:@"SIN" WithLeftValue:@"90" AndRightValue:nil]; // TODO use Function property
    XCTAssertEqualWithAccuracy(1, [self.formulaManager interpretDouble:formula forSpriteObject:self.spriteObject], DELTA, @"Wrong result for sin(90)");
    
    formula = [self getFormulaForFunction:@"SIN" WithLeftValue:@"-90" AndRightValue:nil]; // TODO use Function property
    XCTAssertEqualWithAccuracy(-1, [self.formulaManager interpretDouble:formula forSpriteObject:self.spriteObject], DELTA, @"Wrong result for sin(-90)");
    
    formula = [self getFormulaForFunction:@"SIN" WithLeftValue:@"180" AndRightValue:nil]; // TODO use Function property
    XCTAssertEqualWithAccuracy(0, [self.formulaManager interpretDouble:formula forSpriteObject:self.spriteObject], DELTA, @"Wrong result for sin(180)");
    
    formula = [self getFormulaForFunction:@"SIN" WithLeftValue:@"-180" AndRightValue:nil]; // TODO use Function property
    XCTAssertEqualWithAccuracy(0, [self.formulaManager interpretDouble:formula forSpriteObject:self.spriteObject], DELTA, @"Wrong result for sin(-180)");
    
    formula = [self getFormulaForFunction:@"SIN" WithLeftValue:@"360" AndRightValue:nil]; // TODO use Function property
    XCTAssertEqualWithAccuracy(0, [self.formulaManager interpretDouble:formula forSpriteObject:self.spriteObject], DELTA, @"Wrong result for sin(360)");
    
    formula = [self getFormulaForFunction:@"SIN" WithLeftValue:@"750" AndRightValue:nil]; // TODO use Function property
    XCTAssertEqualWithAccuracy(0.5, [self.formulaManager interpretDouble:formula forSpriteObject:self.spriteObject], DELTA, @"Wrong result for sin(750)");
...
- (void)testCos
{
    ...
    XCTAssertEqualWithAccuracy(-1, [self.formulaManager interpretDouble:formula forSpriteObject:self.spriteObject], DELTA, @"Wrong result for cos(180)");
...
- (void)testTan
{
    ...
    XCTAssertEqualWithAccuracy(0, [self.formulaManager interpretDouble:formula forSpriteObject:self.spriteObject], DELTA, @"Wrong result for tan(0)");
    ...
    XCTAssertEqualWithAccuracy(1.633123935319537 * pow(10,16), [self.formulaManager interpretDouble:formula forSpriteObject:self.spriteObject], DELTA, @"Wrong result for tan(90)");
    ...
    XCTAssertEqualWithAccuracy(0, [self.formulaManager interpretDouble:formula forSpriteObject:self.spriteObject], DELTA, @"Wrong result for tan(180)");
    
    formula = [self getFormulaForFunction:@"TAN" WithLeftValue:@"-180" AndRightValue:nil]; // TODO use Function property
    XCTAssertEqualWithAccuracy(0, [self.formulaManager interpretDouble:formula forSpriteObject:self.spriteObject], DELTA, @"Wrong result for tan(-180)");
    
    formula = [self getFormulaForFunction:@"TAN" WithLeftValue:@"360" AndRightValue:nil]; // TODO use Function property
    XCTAssertEqualWithAccuracy(0, [self.formulaManager interpretDouble:formula forSpriteObject:self.spriteObject], DELTA, @"Wrong result for tan(360)");
    
    formula = [self getFormulaForFunction:@"TAN" WithLeftValue:@"-360" AndRightValue:nil]; // TODO use Function property
    XCTAssertEqualWithAccuracy(0, [self.formulaManager interpretDouble:formula forSpriteObject:self.spriteObject], DELTA, @"Wrong result for tan(-360)");
    
    formula = [self getFormulaForFunction:@"TAN" WithLeftValue:@"750" AndRightValue:nil]; // TODO use Function property
    XCTAssertEqualWithAccuracy(0.57735026919, [self.formulaManager interpretDouble:formula forSpriteObject:self.spriteObject], DELTA, @"Wrong result for tan(750)");
...
- (void)testArcSin
{
    ...
    XCTAssertEqualWithAccuracy(0, [self.formulaManager interpretDouble:formula forSpriteObject:self.spriteObject], DELTA, @"Wrong result for arcsin(0)");
    ...
    XCTAssertEqualWithAccuracy(90, [self.formulaManager interpretDouble:formula forSpriteObject:self.spriteObject], DELTA, @"Wrong result for arcsin(sin(90))");
...
- (void)testArcCos
{
    ...
    XCTAssertEqualWithAccuracy(90, [self.formulaManager interpretDouble:formula forSpriteObject:self.spriteObject], DELTA, @"Wrong result for arccos(0)");
    
    formula = [self getFormulaForFunction:@"ACOS" WithLeftValue:@"1" AndRightValue:nil]; // TODO use Function property
    XCTAssertEqualWithAccuracy(0, [self.formulaManager interpretDouble:formula forSpriteObject:self.spriteObject], DELTA, @"Wrong result for arccos(1)");
    
    formula = [self getFormulaForFunction:@"ACOS" WithLeftValue:@"-1" AndRightValue:nil]; // TODO use Function property
    XCTAssertEqualWithAccuracy(180, [self.formulaManager interpretDouble:formula forSpriteObject:self.spriteObject], DELTA, @"Wrong result for arccos(-1)");
    ...
    XCTAssertEqualWithAccuracy(90, [self.formulaManager interpretDouble:formula forSpriteObject:self.spriteObject], DELTA, @"Wrong result for arccos(cos(90))");
    ...
    XCTAssertEqualWithAccuracy(180, [self.formulaManager interpretDouble:formula forSpriteObject:self.spriteObject], DELTA, @"Wrong result for arccos(cos(180))");
...
- (void)testArcTan
{
    ...
    XCTAssertEqualWithAccuracy(0, [self.formulaManager interpretDouble:formula forSpriteObject:self.spriteObject], DELTA, @"Wrong result for arctan(0)");
    ...
    XCTAssertEqualWithAccuracy(60, [self.formulaManager interpretDouble:formula forSpriteObject:self.spriteObject], DELTA, @"Wrong result for arctan(tan(60))");
