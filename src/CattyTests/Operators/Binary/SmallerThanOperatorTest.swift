...
class SmallerThanOperatorTest: XCTestCase {

    var op: SmallerThanOperator!

    override func setUp() {
        super.setUp()
        op = SmallerThanOperator()
    }
    ...
    func testValue() {
        ...
        XCTAssertFalse(op.value(left: "abc" as AnyObject, right: "bcd" as AnyObject))
