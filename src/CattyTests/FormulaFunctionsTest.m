...
- (void)testSin
{
    ...
    XCTAssertEqualWithAccuracy(0, [formula interpretRecursiveForSprite:nil], DELTA, @"Wrong result for sin(0)");
    
    formula = [self getFormulaElementForFunction:SIN WithLeftValue:@"90" AndRightValue:nil];
    XCTAssertEqualWithAccuracy(1, [formula interpretRecursiveForSprite:nil], DELTA, @"Wrong result for sin(90)");
    
    formula = [self getFormulaElementForFunction:SIN WithLeftValue:@"-90" AndRightValue:nil];
    XCTAssertEqualWithAccuracy(-1, [formula interpretRecursiveForSprite:nil], DELTA, @"Wrong result for sin(-90)");
    
    formula = [self getFormulaElementForFunction:SIN WithLeftValue:@"180" AndRightValue:nil];
    XCTAssertEqualWithAccuracy(0, [formula interpretRecursiveForSprite:nil], DELTA, @"Wrong result for sin(180)");
    
    formula = [self getFormulaElementForFunction:SIN WithLeftValue:@"-180" AndRightValue:nil];
    XCTAssertEqualWithAccuracy(0, [formula interpretRecursiveForSprite:nil], DELTA, @"Wrong result for sin(-180)");
    
    formula = [self getFormulaElementForFunction:SIN WithLeftValue:@"360" AndRightValue:nil];
    XCTAssertEqualWithAccuracy(0, [formula interpretRecursiveForSprite:nil], DELTA, @"Wrong result for sin(360)");
    
    formula = [self getFormulaElementForFunction:SIN WithLeftValue:@"750" AndRightValue:nil];
    XCTAssertEqualWithAccuracy(0.5, [formula interpretRecursiveForSprite:nil], DELTA, @"Wrong result for sin(750)");
...
- (void)testCos
{
    ...
    XCTAssertEqualWithAccuracy(1, [formula interpretRecursiveForSprite:nil], DELTA, @"Wrong result for cos(0)");

    formula = [self getFormulaElementForFunction:COS WithLeftValue:@"90" AndRightValue:nil];
    XCTAssertEqualWithAccuracy(0, [formula interpretRecursiveForSprite:nil], DELTA, @"Wrong result for cos(90)");
    
    formula = [self getFormulaElementForFunction:COS WithLeftValue:@"-90" AndRightValue:nil];
    XCTAssertEqualWithAccuracy(0, [formula interpretRecursiveForSprite:nil], DELTA, @"Wrong result for cos(-90)");
    
    formula = [self getFormulaElementForFunction:COS WithLeftValue:@"180" AndRightValue:nil];
    XCTAssertEqualWithAccuracy(-1, [formula interpretRecursiveForSprite:nil], DELTA, @"Wrong result for cos(180)");
    
    formula = [self getFormulaElementForFunction:COS WithLeftValue:@"-180" AndRightValue:nil];
    XCTAssertEqualWithAccuracy(-1, [formula interpretRecursiveForSprite:nil], DELTA, @"Wrong result for cos(-180)");
    
    formula = [self getFormulaElementForFunction:COS WithLeftValue:@"360" AndRightValue:nil];
    XCTAssertEqualWithAccuracy(1, [formula interpretRecursiveForSprite:nil], DELTA, @"Wrong result for cos(360)");

    formula = [self getFormulaElementForFunction:COS WithLeftValue:@"-360" AndRightValue:nil];
    XCTAssertEqualWithAccuracy(1, [formula interpretRecursiveForSprite:nil], DELTA, @"Wrong result for cos(-360)");

    formula = [self getFormulaElementForFunction:COS WithLeftValue:@"750" AndRightValue:nil];
    XCTAssertEqualWithAccuracy(0.86602540378, [formula interpretRecursiveForSprite:nil], DELTA, @"Wrong result for cos(750)");
...
- (void)testTan
{
    ...
    XCTAssertEqualWithAccuracy(0, [formula interpretRecursiveForSprite:nil], DELTA, @"Wrong result for tan(0)");
    ...
    XCTAssertEqualWithAccuracy(1.633123935319537 * pow(10,16), [formula interpretRecursiveForSprite:nil], DELTA, @"Wrong result for tan(90)");
    
    formula = [self getFormulaElementForFunction:TAN WithLeftValue:@"-90" AndRightValue:nil];
    XCTAssertEqualWithAccuracy(-1.633123935319537 * pow(10,16), [formula interpretRecursiveForSprite:nil], DELTA, @"Wrong result for tan(-90)");
    
    formula = [self getFormulaElementForFunction:TAN WithLeftValue:@"180" AndRightValue:nil];
    XCTAssertEqualWithAccuracy(0, [formula interpretRecursiveForSprite:nil], DELTA, @"Wrong result for tan(180)");
    
    formula = [self getFormulaElementForFunction:TAN WithLeftValue:@"-180" AndRightValue:nil];
    XCTAssertEqualWithAccuracy(0, [formula interpretRecursiveForSprite:nil], DELTA, @"Wrong result for tan(-180)");
    
    formula = [self getFormulaElementForFunction:TAN WithLeftValue:@"360" AndRightValue:nil];
    XCTAssertEqualWithAccuracy(0, [formula interpretRecursiveForSprite:nil], DELTA, @"Wrong result for tan(360)");
    
    formula = [self getFormulaElementForFunction:TAN WithLeftValue:@"-360" AndRightValue:nil];
    XCTAssertEqualWithAccuracy(0, [formula interpretRecursiveForSprite:nil], DELTA, @"Wrong result for tan(-360)");
    
    formula = [self getFormulaElementForFunction:TAN WithLeftValue:@"750" AndRightValue:nil];
    XCTAssertEqualWithAccuracy(0.57735026919, [formula interpretRecursiveForSprite:nil], DELTA, @"Wrong result for tan(750)");
...
- (void)testArcSin
{
    ...
    XCTAssertEqualWithAccuracy(0, [formula interpretRecursiveForSprite:nil], DELTA, @"Wrong result for arcsin(0)");
    ...
    XCTAssertEqualWithAccuracy(90, [formula interpretRecursiveForSprite:nil], DELTA, @"Wrong result for arcsin(sin(90))");
    ...
    double result = [formula interpretRecursiveForSprite:nil];
...
- (void)testArcCos
{
    ...
    XCTAssertEqualWithAccuracy(90, [formula interpretRecursiveForSprite:nil], DELTA, @"Wrong result for arccos(0)");
    
    formula = [self getFormulaElementForFunction:ARCCOS WithLeftValue:@"1" AndRightValue:nil];
    XCTAssertEqualWithAccuracy(0, [formula interpretRecursiveForSprite:nil], DELTA, @"Wrong result for arccos(1)");
    
    formula = [self getFormulaElementForFunction:ARCCOS WithLeftValue:@"-1" AndRightValue:nil];
    XCTAssertEqualWithAccuracy(180, [formula interpretRecursiveForSprite:nil], DELTA, @"Wrong result for arccos(-1)");
    ...
    XCTAssertEqualWithAccuracy(90, [formula interpretRecursiveForSprite:nil], DELTA, @"Wrong result for arccos(cos(90))");
    ...
    XCTAssertEqualWithAccuracy(180, [formula interpretRecursiveForSprite:nil], DELTA, @"Wrong result for arccos(cos(180))");
...
- (void)testArcTan
{
    ...
    XCTAssertEqualWithAccuracy(0, [formula interpretRecursiveForSprite:nil], DELTA, @"Wrong result for arctan(0)");
    ...
    XCTAssertEqualWithAccuracy(60, [formula interpretRecursiveForSprite:nil], DELTA, @"Wrong result for arctan(tan(60))");
