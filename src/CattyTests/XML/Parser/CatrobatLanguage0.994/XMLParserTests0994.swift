...
class XMLParserTests0994: XMLAbstractTest {
    ...
    func testFlashBrick() {
        let project = self.getProjectForXML(xmlFile: "LedFlashBrick0994")
    ...
    func testIfThenLogicBeginBrick() {
        let project = self.getProjectForXML(xmlFile: "LogicBricks_0994")
    ...
    func testChooseCameraBrick() {
        let project = self.getProjectForXML(xmlFile: "CameraBricks_0994")
        let background = project.scene.object(at: 0)!
    ...
    func testNumberOfItemsFunction() {
        let project = self.getProjectForXML(xmlFile: "NumberOfItemsInListFunction0994")
        XCTAssertEqual(1, project.scene.objects().count, "Invalid object list")
    ...
    func testElementOfListFunction() {
        let project = self.getProjectForXML(xmlFile: "ElementOfListFunction0994")
        XCTAssertEqual(1, project.scene.objects().count, "Invalid object list")
    ...
    func testDeleteItemOfUserListBrick() {
        let project = self.getProjectForXML(xmlFile: "DeleteItemOfUserListBrick0994")
        XCTAssertEqual(1, project.scene.objects().count, "Invalid object list")
    ...
    func testInsertItemIntoUserListBrick() {
        let project = self.getProjectForXML(xmlFile: "InsertItemIntoUserListBrick0994")
        XCTAssertEqual(1, project.scene.objects().count, "Invalid object list")
    ...
    func testReplaceItemInUserListBrick() {
        let project = self.getProjectForXML(xmlFile: "ReplaceItemInUserListBrick0994")
        XCTAssertEqual(1, project.scene.objects().count, "Invalid object list")
    ...
    func testDisabledBricks() {
        let project = self.getProjectForXML(xmlFile: "DisabledBricks_0994")
        let object = project.scene.object(at: 0)!
