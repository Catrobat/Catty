...
final class TripleStitchPatternTests: XCTestCase {
    ...
    func testSimpleLine() {
        ...
        embroideryStream!.activePattern = TripleStitchPattern(for: embroideryStream!,
                                                              at: .zero,
                                                              with: 20)
    ...
    func testSquareNonDivisibleLength() {
        ...
        reference.add(Stitch(x: 18.07, y: 18.56))
        reference.add(Stitch(x: 19, y: 9))

        reference.add(Stitch(x: 9, y: 4))
        reference.add(Stitch(x: 18.57, y: 8.57))
        reference.add(Stitch(x: 9, y: 4))
