...
final class XMLMappingFromObjcHeaderTests: XCTestCase {
    ...
    func testHeadersAreEqual() {
        ...
        compareHeaders(projectA: mappedProject!, projectB: cbProject)
    }
    ...
    func compareHeaders(projectA: CBProject, projectB: CBProject) {
        ...
        XCTAssertEqual(projectA.header!.description, projectB.header!.description)
