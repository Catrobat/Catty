...
let kLocaliedReportedProject = NSLocalizedString("Your report was successfully sent!", bundle: Bundle(for: LanguageTranslation.self), comment: "")
let kLocalizedProjectNotReported = NSLocalizedString("Project couldn't be reported", bundle: Bundle(for: LanguageTranslation.self), comment: "")
