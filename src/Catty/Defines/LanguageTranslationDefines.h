...
#define kLocalizedDeleteThisProject NSLocalizedString(@"Delete this program", nil)
...
#define kLocalizedNotEnoughFreeMemoryDescription NSLocalizedString(@"Not enough free memory to download this program. Please delete some of your projects", nil)
...
#define kLocalizedProjectAlreadyDownloadedDescription NSLocalizedString(@"You have already downloaded this program!", nil)
