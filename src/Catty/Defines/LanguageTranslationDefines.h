...
#define kLocalizedEnterNameForImportedProgramTitle NSLocalizedString(@"Import Program", @"Title of prompt shown if a file is imported e.g. from the browser with the ending *.catrobat")
