...
#define kLocalizedSetX NSLocalizedString(@"Set X", nil)
#define kLocalizedSetY NSLocalizedString(@"Set Y", nil)
#define kLocalizedChangeX NSLocalizedString(@"Change X", nil)
#define kLocalizedChangeY NSLocalizedString(@"Change Y", nil)
