...
#define kLocaliedReportedProject NSLocalizedString(@"Your report was successfully sent!", nil)
#define kLocalizedProjectNotReported NSLocalizedString(@"Project couldn't be reported", nil)
