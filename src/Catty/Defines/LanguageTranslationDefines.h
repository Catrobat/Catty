...
#define kLocalizedProgramNotFound NSLocalizedString(@"The requested program can not be found. Please choose a different one.", nil)
...
#define kUIFESensorFingerTouched NSLocalizedString(@"finger_touched", nil)
#define kUIFESensorFingerX NSLocalizedString(@"finger_x", nil)
#define kUIFESensorFingerY NSLocalizedString(@"finger_y", nil)
#define kUIFESensorLastFingerIndex NSLocalizedString(@"last_finger_index", nil)
