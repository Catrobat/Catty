...
class NetworkDefines: NSObject {
    ...
    @objc static var baseUrlDefault = true
    static let baseUrlProd = "https://share.catrob.at/pocketcode/"
    static let baseUrlTest = "https://web-test.catrob.at/pocketcode/"
    static var baseUrl: String {
        #if DEBUG
        return baseUrlDefault ? baseUrlTest : baseUrlProd
        #else
        return baseUrlDefault ? baseUrlProd : baseUrlTest
        #endif
    }
