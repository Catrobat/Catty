...
let kLocaliedReportedProject = NSLocalizedString("Your report was successfully sent!", comment: "")
let kLocalizedProjectNotReported = NSLocalizedString("Project couldn't be reported", comment: "")
