...
let kLocalizedOpenCatrobatWebsite = NSLocalizedString("Catrobat website", comment: "")
...
let kLocalizedSendCrashReports = NSLocalizedString("Send anonymous crash reports", comment: "")
