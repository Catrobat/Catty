...
let kUIFESensorFingerTouched = NSLocalizedString("finger_touched", comment: "")
let kUIFESensorFingerX = NSLocalizedString("finger_x", comment: "")
let kUIFESensorFingerY = NSLocalizedString("finger_y", comment: "")
let kUIFESensorLastFingerIndex = NSLocalizedString("last_finger_index", comment: "")
