...
@objcMembers class SetBackgroundBrick: Brick, BrickLookProtocol {
    ...
    override func brickCell() -> BrickCellProtocol.Type {
        SetBackgroundBrickCell.self as BrickCellProtocol.Type
    }

    override func isEqual(to brick: Brick) -> Bool {
        guard let brick = brick as? SetBackgroundBrick else { return false }
    ...
    override func mutableCopy(with context: CBMutableCopyContext) -> Any {
        let brick = SetBackgroundBrick.init()
