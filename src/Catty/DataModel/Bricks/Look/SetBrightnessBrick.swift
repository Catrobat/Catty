 ...
 */
@objc(SetBrightnessBrick)
@objcMembers class SetBrightnessBrick: Brick, BrickProtocol, BrickFormulaProtocol {
    ...
    override func getRequiredResources() -> Int {
        self.brightness?.getRequiredResources() ?? ResourceType.noResources.rawValue
    }

    override func brickCell() -> BrickCellProtocol.Type! {
        SetBrightnessBrickCell.self as BrickCellProtocol.Type
    }

    override func clone(with script: Script!) -> Brick! {
        let clone = SetBrightnessBrick()
        clone.script = script
