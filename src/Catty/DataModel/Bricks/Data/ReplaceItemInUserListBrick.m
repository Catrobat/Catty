...
{
    ReplaceItemInUserListBrick *clone = [[ReplaceItemInUserListBrick alloc] init];
    clone.script = script;
    ...
    clone.elementFormula = self.elementFormula;
...
{
    if (! [self.userList isEqual:((ReplaceItemInUserListBrick*)brick).userList])
        return NO;
