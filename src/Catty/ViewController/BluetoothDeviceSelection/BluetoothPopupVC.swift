...
class BluetoothPopupVC: MXSegmentedPagerController {
    ...
    override func viewDidLoad() {
        ...
        self.segmentedPager.segmentedControl.titleTextAttributes = [NSForegroundColorAttributeName : UIColor.textTintColor(), NSFontAttributeName: UIFont.systemFontOfSize(12)];
