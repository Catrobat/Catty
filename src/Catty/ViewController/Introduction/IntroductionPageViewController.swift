...
class IntroductionPageViewController: UIPageViewController {
    ...
    private let content = [
        IntroductionViewController.Content(title: kLocalizedWelcomeToPocketCode, description: kLocalizedWelcomeDescription, image: UIImage(named: "page1_logo")!),
        IntroductionViewController.Content(title: kLocalizedExploreApps, description: kLocalizedExploreDescription, image: UIImage(named: "page2_explore")!),
        IntroductionViewController.Content(title: kLocalizedCreateAndEdit, description: kLocalizedCreateAndEditDescription, image: UIImage(named: "page3_info")!)
    ]
