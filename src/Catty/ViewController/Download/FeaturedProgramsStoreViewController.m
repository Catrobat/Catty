...
- (void)loadFeaturedProjects
{
    ...
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%@/%@?%@%i&%@%.2f", kConnectionHost, kConnectionFeatured, kProgramsLimit, kFeaturedProgramsMaxResults, kMaxVersion, kCurrentVersion]];
