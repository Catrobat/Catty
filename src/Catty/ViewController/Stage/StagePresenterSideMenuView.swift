...
@objc class StagePresenterSideMenuView: UIView {
    ...
    private func setUpButtonsLandscape() {
        ...
        screenshotButton.leftAnchor.constraint(equalTo: self.leftAnchor, constant: marginTopBottom * 1).isActive = true
        ...
        axesButton.leftAnchor.constraint(equalTo: screenshotButton.rightAnchor, constant: marginTopBottom * -1).isActive = true
        axesButton.leftAnchor.constraint(equalTo: self.centerXAnchor).isActive = true
        ...
        aspectRatioButton.rightAnchor.constraint(equalTo: self.rightAnchor, constant: marginTopBottom * -2).isActive = true
    ...
    private func setupImage(_ imageName: String, for button: UIButton, type: SideMenuButtonType = .portrait) {
        ...
        if type == .landscapeLarge && self.landscape == true {
            button.frame.size.width = CGFloat(StagePresenterSideMenuView.buttonInitialWidthAndHeight * 2)
            button.frame.size.height = CGFloat(StagePresenterSideMenuView.buttonInitialWidthAndHeight * 2)
