...
- (void)viewDidLoad
{
    ...
    UIImageView* leftView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 41, 20)];
    leftView.backgroundColor = mainColor;
    ...
    UIImageView* leftView2 = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 41, 20)];
    leftView2.backgroundColor = mainColor;
    ...
    currentHeight+= self.forgotButton.frame.size.height;
    ...
    UIImageView* leftView3 = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 41, 20)];
    leftView3.backgroundColor = mainColor;
