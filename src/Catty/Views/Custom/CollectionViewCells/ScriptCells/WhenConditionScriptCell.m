...
#import "WhenConditionScriptCell.h"

@interface WhenConditionScriptCell ()
@property (nonatomic, strong) UILabel *textLabelLeft;
@property (nonatomic, strong) UILabel *textLabelRight;
@end

@implementation WhenConditionScriptCell
...
{
    self.textLabelLeft = inlineViewSubViews[0];
    self.conditionTextField = inlineViewSubViews[1];
    self.textLabelRight = inlineViewSubViews[2];
}
