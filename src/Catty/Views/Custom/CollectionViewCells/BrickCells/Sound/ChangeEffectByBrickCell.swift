...
@objc(ChangeEffectByBrickCell) class ChangeEffectByBrickCell: BrickCell {

    public var firstTextLabel: UILabel?
    public var effectChoiceCombobox: iOSCombobox?
    public var secondTextLabel: UILabel?
    public var effectChangeTextField: UITextField?
    ...
    override func hookUpSubViews(_ inlineViewSubViews: [Any]!) {
        ...
        self.effectChoiceCombobox = inlineViewSubViews[1] as? iOSCombobox
        self.secondTextLabel = inlineViewSubViews[2] as? UILabel
        self.effectChangeTextField = inlineViewSubViews[3] as? UITextField
    }
}
