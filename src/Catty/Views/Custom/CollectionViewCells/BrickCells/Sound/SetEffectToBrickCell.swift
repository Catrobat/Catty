...
@objc(SetEffectToBrickCell) class SetEffectToBrickCell: BrickCell {
    ...
    override func hookUpSubViews(_ inlineViewSubViews: [Any]!) {
        ...
        self.effectValueTextField = inlineViewSubViews[3] as? UITextField
    }
}
