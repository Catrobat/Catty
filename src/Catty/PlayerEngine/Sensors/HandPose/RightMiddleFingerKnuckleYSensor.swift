...
class RightMiddleFingerKnuckleYSensor: DeviceDoubleSensor {

    static let tag = "RIGHT_MIDDLE_FINGER_Y"
    static let name = kUIFESensorRightMiddleFingerKnuckleY
    static let defaultRawValue = 0.0
    static let position = 820
