...
class LeftRingFingerKnuckleXSensor: DeviceDoubleSensor {

    static let tag = "LEFT_RING_FINGER_X"
    static let name = kUIFESensorLeftRingFingerKnuckleX
    static let defaultRawValue = 0.0
    static let position = 730
