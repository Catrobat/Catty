...
class RightMiddleFingerKnuckleXSensor: DeviceDoubleSensor {

    static let tag = "RIGHT_MIDDLE_FINGER_X"
    static let name = kUIFESensorRightMiddleFingerKnuckleX
    static let defaultRawValue = 0.0
    static let position = 810
