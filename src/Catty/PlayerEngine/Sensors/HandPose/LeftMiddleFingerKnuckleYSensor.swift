...
class LeftMiddleFingerKnuckleYSensor: DeviceDoubleSensor {

    static let tag = "LEFT_MIDDLE_FINGER_Y"
    static let name = kUIFESensorLeftMiddleFingerKnuckleY
    static let defaultRawValue = 0.0
    static let position = 760
