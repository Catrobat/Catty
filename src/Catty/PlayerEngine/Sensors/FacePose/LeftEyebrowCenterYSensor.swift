...
class LeftEyebrowCenterYSensor: DeviceDoubleSensor {

    static let tag = "LEFT_EYEBROW_CENTER_Y"
    static let name = kUIFESensorLeftEyebrowCenterY
    static let defaultRawValue = 0.0
    static let position = 480
