...
class RightEyebrowOuterXSensor: DeviceDoubleSensor {

    static let tag = "RIGHT_EYEBROW_OUTER_X"
    static let name = kUIFESensorRightEyebrowOuterX
    static let defaultRawValue = 0.0
    static let position = 570
