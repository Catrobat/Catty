...
class MouthRightCornerXSensor: DeviceDoubleSensor {

    static let tag = "MOUTH_RIGHT_CORNER_X"
    static let name = kUIFESensorMouthRightCornerX
    static let defaultRawValue = 0.0
    static let position = 430
