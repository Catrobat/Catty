...
class RightEyebrowOuterYSensor: DeviceDoubleSensor {

    static let tag = "RIGHT_EYEBROW_OUTER_Y"
    static let name = kUIFESensorRightEyebrowOuterY
    static let defaultRawValue = 0.0
    static let position = 580
