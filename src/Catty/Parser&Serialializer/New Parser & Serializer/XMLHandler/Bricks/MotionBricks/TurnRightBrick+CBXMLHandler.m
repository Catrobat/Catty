...
+ (instancetype)parseFromElement:(GDataXMLElement*)xmlElement withContext:(CBXMLParserContext*)context
{
    ...
    Formula *formula = [CBXMLParserHelper formulaInXMLElement:xmlElement forCategoryName:@"TURN_RIGHT_DEGREES" withContext:context];
...
- (GDataXMLElement*)xmlElementWithContext:(CBXMLSerializerContext*)context
{
    ...
    [brick addAttribute:[GDataXMLElement attributeWithName:@"type" escapedStringValue:@"TurnRightBrick"]];
    GDataXMLElement *formulaList = [GDataXMLElement elementWithName:@"formulaList" context:context];
    GDataXMLElement *formula = [self.degrees xmlElementWithContext:context];
    [formula addAttribute:[GDataXMLElement attributeWithName:@"category" escapedStringValue:@"TURN_RIGHT_DEGREES"]];
