...
- (GDataXMLElement*)xmlElementWithContext:(CBXMLContext*)context
{
    ...
    [brick addAttribute:[GDataXMLElement elementWithName:@"type" stringValue:@"ChangeYByNBrick"]];
    ...
    [formula addAttribute:[GDataXMLElement elementWithName:@"category" stringValue:@"Y_POSITION_CHANGE"]];
