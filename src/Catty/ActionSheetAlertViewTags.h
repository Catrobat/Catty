...
#define kCopyProgramAlertViewTag 104
#define kInvalidProgramNameWarningAlertViewTag 105
#define kInvalidObjectNameWarningAlertViewTag 106
#define kNoInternetConnection 107
