...
//    self.textLabelLeft.frame = CGRectMake(kBrickLabelOffsetX, kBrickLabelOffsetY, self..frame.size.width, self..frame.size.height);
...
//    self.delayInput.frame = CGRectMake(offsetX, kBrickLabelOffsetY, 40.0f, self..frame.size.height);
//    offsetX += 40.0f;
//
////    self.textLabelRight.frame = CGRectMake(offsetX, kBrickLabelOffsetY, (self..frame.size.width - offsetX), self..frame.size.height);
