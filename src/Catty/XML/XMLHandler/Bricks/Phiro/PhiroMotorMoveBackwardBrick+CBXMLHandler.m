...
#import "PhiroMotorMoveBackwardBrick+CBXMLHandler.h"
...
@implementation PhiroMotorMoveBackwardBrick (CBXMLHandler)
...
{
    GDataXMLElement *brick = [super xmlElementForBrickType:@"PhiroMotorMoveBackwardBrick" withContext:context];
