...
class JoinThreeStringsFunction: TripleParameterStringFunction {
    static var tag = "JOIN3"
    ...
    func value(firstParameter: AnyObject?, secondParameter: AnyObject?, thirdParameter: AnyObject?) -> String {
        ...
        let thirdText = type(of: self).interpretParameter(parameter: thirdParameter)
