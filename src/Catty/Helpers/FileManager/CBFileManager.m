...
- (void)storeDownloadedProject:(NSData *)data andTask:(NSURLSessionDownloadTask *)task
{
    ...
    [self unzipAndStore:data withProjectID:projectID withName:name];
...
- (void)unzipAndStore:(NSData*)projectData withProjectID:(NSString*)projectID withName:(NSString*)name
{
    NSError *error;
